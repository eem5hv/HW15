...
--return all the things in both lists...
...
-- Return true if p is true (p is a function that returns a boolean
-- value) for every v in s, otherwise false...you get a list of bools,
-- true is the identity of the and because a value*true = a
-- value. Fold takes a function, an Id, and a list and returns that
-- function applied to to the list. "and" returns true if and only if
...
set_eql1: (eq a) => set a -> set a -> bool
set_eql1 (mkSet l1) (mkSet l2) = same_elements l1 l2
